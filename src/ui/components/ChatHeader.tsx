...
/*
 * Documentation:
 * Chat Header — https://app.subframe.com/002445ea7110/library?component=Chat+Header_d433f068-1938-4805-865a-295917565aeb
    ...
    return (
      ...
      >
        ...
        <div className="flex grow shrink-0 basis-0 flex-col items-start">
          {name ? (
            <span className="w-full text-h3 font-h3 text-text-primary">
              {name}
            </span>
          ) : null}
          {subtitle ? (
