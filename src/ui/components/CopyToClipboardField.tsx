...
/*
 * Documentation:
 * Copy to clipboard field — https://app.subframe.com/002445ea7110/library?component=Copy+to+clipboard+field_1e2e1a38-8b4a-41bd-b224-b893c92a0495
 * Copy to clipboard button — https://app.subframe.com/002445ea7110/library?component=Copy+to+clipboard+button_e8c76626-6462-4f2f-b595-38d530d427e8
 */
  ...
  return (
    ...
    >
      <div className="flex grow shrink-0 basis-0 items-start gap-1 py-0.5">
        {text ? (
          <span className="grow shrink-0 basis-0 whitespace-pre-wrap text-monospace-body font-monospace-body text-text-secondary">
            {text}
          </span>
        ) : null}
      </div>
