...
/*
 * Documentation:
 * Progress — https://app.subframe.com/002445ea7110/library?component=Progress_60964db0-a1bf-428b-b9d5-f34cdf58ea77
 */
      ...
      <SubframeCore.Progress.Indicator asChild={true} {...otherProps}>
        <div
          className={SubframeUtils.twClassNames(
            "flex h-2 w-full flex-col items-start gap-2 rounded-full bg-brand-500",
            className
          )}
          ref={ref as any}
        />
