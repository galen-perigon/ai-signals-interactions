...
/*
 * Documentation:
 * Modern navbar — https://app.subframe.com/002445ea7110/library?component=Modern+navbar_cba8555a-1e5a-4a57-8c3d-6ad67c2ef976
...
const NavItem = React.forwardRef<HTMLElement, NavItemProps>(function NavItem(
  ...
  return (
    ...
    >
      {children ? (
        <span className="text-body-bold font-body-bold text-text-secondary group-hover/4f025ecf:text-text-primary">
          {children}
        </span>
      ) : null}
    </div>
