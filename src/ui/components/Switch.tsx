...
/*
 * Documentation:
 * Switch — https://app.subframe.com/002445ea7110/library?component=Switch_7a464794-9ea9-4040-b1de-5bfb2ce599d9
 */
  ...
  function SwitchRoot({ className, ...otherProps }: SwitchRootProps, ref) {
    return (
      <SubframeCore.Switch.Root asChild={true} {...otherProps}>
        <div
          className={SubframeUtils.twClassNames(
            "group/7a464794 flex h-5 w-8 cursor-pointer flex-col items-start justify-center gap-2 rounded-full border border-solid border-neutral-200 bg-neutral-200 px-0.5 py-0.5 aria-[checked=true]:border aria-[checked=true]:border-solid aria-[checked=true]:border-brand-500 aria-[checked=true]:bg-brand-500",
            className
          )}
          ref={ref as any}
        >
