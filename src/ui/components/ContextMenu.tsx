...
/*
 * Documentation:
 * Context Menu — https://app.subframe.com/002445ea7110/library?component=Context+Menu_f8a49f07-fa5b-46c8-9399-cbbf0930cc62
    ...
    return (
      <SubframeCore.ContextMenu.Item asChild={true} {...otherProps}>
        ...
        >
          ...
          {children ? (
            <span className="line-clamp-1 grow shrink-0 basis-0 text-body font-body text-text-primary group-hover/9358ee78:text-text-primary">
              {children}
            </span>
          ) : null}
          {rightSlot ? (
...
const ContextMenuRoot = React.forwardRef<HTMLElement, ContextMenuRootProps>(
  function ContextMenuRoot(
    ...
    return children ? (
      <div
        className={SubframeUtils.twClassNames(
          "flex min-w-[192px] flex-col items-start rounded-md border border-solid border-brand-200 bg-background-primary px-1 py-1 shadow-lg",
          className,
        )}
        ref={ref as any}
        {...otherProps}
