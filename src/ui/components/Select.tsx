  ...
  return (
    ...
    >
      ...
      >
        ...
        <SubframeCore.Icon
          className="hidden text-body font-body text-text-primary group-hover/969e345b:hidden group-data-[state=checked]/969e345b:inline-flex group-data-[state=checked]/969e345b:text-brand-500"
          name="FeatherCheck"
        />
      </div>
    </SubframeCore.Select.Item>
    ...
    return (
      ...
      >
        ...
        >
          ...
          <div
            className={SubframeUtils.twClassNames(
              "flex h-8 w-full flex-none flex-col items-start rounded-md border border-solid border-brand-200 bg-background-primary group-focus-within/bb88f90b:border group-focus-within/bb88f90b:border-solid group-focus-within/bb88f90b:border-neutral-400",
              {
                "border border-solid border-border-primary bg-background-tertiary group-hover/bb88f90b:border group-hover/bb88f90b:border-solid group-hover/bb88f90b:border-border-primary group-hover/bb88f90b:bg-background-tertiary":
                  variant === "filled",
