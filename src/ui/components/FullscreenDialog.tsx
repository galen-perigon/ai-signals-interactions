...
/*
 * Documentation:
 * Fullscreen Dialog — https://app.subframe.com/002445ea7110/library?component=Fullscreen+Dialog_3f094173-71de-4378-a09a-05c482f7a137
    ...
    <SubframeCore.FullScreenDialog.Root asChild={true} {...otherProps}>
      <div
        className={SubframeUtils.twClassNames(
          "flex h-full w-full flex-col items-start bg-background-primary",
          className,
        )}
        ref={ref as any}
      >
