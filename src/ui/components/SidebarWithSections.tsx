...
/*
 * Documentation:
 * Sidebar with sections — https://app.subframe.com/002445ea7110/library?component=Sidebar+with+sections_f4047c8b-cfb4-4761-b9cf-fbcae8a9b9b5
    ...
    return (
      ...
      >
        <div className="flex w-full flex-col items-start gap-4 px-3 py-1">
          {label ? (
            <span className="w-full text-caption-bold font-caption-bold text-text-secondary">
              {label}
            </span>
          ) : null}
        </div>
...
>(function SidebarWithSectionsRoot(
  ...
  return (
    ...
    >
      ...
      {footer ? (
        <div className="flex w-full items-center gap-4 border-t border-solid border-brand-200 px-6 py-6">
          {footer}
        </div>
      ) : null}
    </nav>
